...
export default async function ImplantacoesPage() {
    ...
    <LayoutProtegido>
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        <div className="w-16 h-16 rounded-2xl bg-[#f5eded] flex items-center justify-center mb-5">
          <Hotel size={28} className="text-[#451a1a]" />
        </div>
        <h1 className="text-xl font-bold text-[#1a1917] mb-2">Implantações de Hotéis</h1>
